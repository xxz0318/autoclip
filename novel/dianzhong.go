...
type dzBookListRsp struct {
	Code    int32  `json:"code"`
	Message string `json:"message"`
	LogId   string `json:"log_id"`
	Data    struct {
		RankBooks []dzBook `json:"rank_books"`
		Total     int64    `json:"total"`
		PageIndex int32    `json:"page_index"`
	} `json:"data"`
}
type dzBookRsp struct {
	Code    int32  `json:"code"`
	Message string `json:"message"`
	LogId   string `json:"log_id"`
	Data    struct {
...
type dzChapterContentRsp struct {
	Code    int32   `json:"code"`
	Message string  `json:"message"`
	LogId   string  `json:"log_id"`
...
type DianZhong struct {
}

func (f DianZhong) GetChapterContentByBookId(ctx context.Context, bookId int64) (string, error) {
...
// GetBookList 获取书籍列表
func (f DianZhong) GetBookList(ctx context.Context, pageIndex, pageSize int32) ([]book, int64, error) {
	if pageIndex < 0 {
		pageIndex = 0
	}
	if pageSize < 0 {
...
// GetBookInfo 获取书籍信息
func (f DianZhong) GetBookInfo(ctx context.Context, bookId int64) (book, error) {
	var bookInfo book
	if bookId <= 0 {
		return bookInfo, nil
	}
...
func (f DianZhong) GetChapterInfo(ctx context.Context, bookId int64) (chapter, error) {
...
func (f DianZhong) GetChapterContent(ctx context.Context, bookId, itemId int64) (string, error) {
...
func setDZHeader(ctx context.Context, req *http.Request) {
...
func replaceDzPlaceholder(ctx context.Context, str string) string {
